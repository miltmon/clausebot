  ...
  const stepsData = [
    {
      number: "01",
      title: "API Access",
      description: "Request API credentials and documentation. Begin with test environment access.",
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "02",
      title: "Standards Configuration",
      description: "Select applicable code standards (AWS D1.1, ASME IX, API 1104) and configure for your workflow.",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "03",
      title: "System Integration",
      description: "Connect ClauseBot API to your existing systems. Implement role-based access and audit trails.",
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "04",
      title: "Production Deployment",
      description: "Deploy to production with full compliance monitoring, automated alerts, and performance tracking.",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=800&q=80"
    }
  ];
    ...
    <section className="py-20 bg-white relative" id="how-it-works" ref={sectionRef}>
      ...
      <div className="section-container">
        <div className="text-center mb-16 opacity-0 fade-in-stagger">
          ...
          <h2 className="section-title mb-4">Integration Process</h2>
          <p className="section-subtitle mx-auto">
            Four-step deployment from API access to production monitoring.
          </p>
        </div>
